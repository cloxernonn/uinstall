...
#English - [1]
#Russian - [2]"
del_or_save_en="[TL] Do you definitely want to remove TLauncher? (y/n)"
del_or_save_ru="[TL] Вы точно хотите удалить TLauncher? (y/n)"
uinstall_comp_en="[TL] The removal is completed"
uinstall_comp_ru="[TL] Удаление завершено"
uinstall_canc_en="[TL] The removal is canceled"
uinstall_canc_ru="[TL] Удаление отменено"
#variable
num_of_sel_lang=""
del_or_save=""
